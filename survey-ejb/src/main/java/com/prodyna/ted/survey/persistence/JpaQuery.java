...
class JpaQuery<T> implements PersistenceQuery<T> {
    ...
    public int executeUpdate() throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error executing update query '" + this.queryString + "'.", e);
        }
    }
    ...
    public List<T> getResultList() throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error executing Query '" + this.queryString + "'.", e);
        }
    }
    ...
    public T getSingleResult() throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error retrieving single result from query '" + this.queryString + "'.", e);
        }
    }
    ...
    public PersistenceQuery<T> setFirstResult(int firstResult) throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error setting first result for query '" + this.queryString + "'.", e);
        }
    }
    ...
    public PersistenceQuery<T> setMaxResults(int maxResults) throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error setting max result for query '" + this.queryString + "'.", e);
        }
    }
    ...
    public PersistenceQuery<T> setParameter(Parameter<T> name, T value) throws PersistenceException {
        ...
        try {
            ...
            throw new PersistenceException("Error setting parameter '" + name.getName() + "' into query '" + this.queryString + "'.");
        }
    }
